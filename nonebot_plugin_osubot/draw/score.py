...
async def draw_score_pic(score_info: UnifiedScore, info: UnifiedUser, map_json, grank, is_lazer, source) -> BytesIO:
    ...
    if score_info.ruleset_id == 0 or score_info.ruleset_id == 4:
    ...
    elif score_info.ruleset_id == 1 or score_info.ruleset_id == 5:
        draw.text(
            (1118, 550),
            f"{score_info.accuracy:.2f}%",
            font=Torus_Regular_30,
    ...
    elif score_info.ruleset_id == 2 or score_info.ruleset_id == 6:
        draw.text(
            (1083, 550),
            f"{score_info.accuracy:.2f}%",
            font=Torus_Regular_30,
...
def cal_legacy_rank(score_info: UnifiedScore, is_hidden: bool):
    ...
    elif score_info.ruleset_id == 0 or score_info.ruleset_id == 4:
